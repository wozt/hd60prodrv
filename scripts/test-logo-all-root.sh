...
echo
echo "== i2c1a_c0_dc_db =="
timeout 10s cat "$DBG/i2c1a_c0_dc_db"

echo
echo "== logo_upload_all =="
timeout 40s cat "$DBG/logo_upload_all"
...
echo
echo "== mailbox_regs =="
timeout 10s cat "$DBG/mailbox_regs"

echo
echo "== bar5_regs =="
timeout 10s cat "$DBG/bar5_regs"

echo
echo "== dmesg =="
dmesg | grep hd60prodrv | tail -100
